...
# Pomodoro countdown timer for Raspberry Pi and Pimoroni Scroll pHAT
# Counts down over 25 minutes, then flashes
# Usage: ./scrollodoro.py [# minutes]
...
# print "Counting down " + (str)minutes + " minutes"
