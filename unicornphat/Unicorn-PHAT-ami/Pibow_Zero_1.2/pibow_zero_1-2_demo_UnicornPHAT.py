#!/usr/bin/env python
################################################################
#          Pibow Zero 1.2 Demo for the Unicorn pHAT            #
################################################################
# Description:                                                 #
...
color_list = [
    (127,0,255), (0,0,255), (0,204,204), (255, 255, 255) 
]
    
y_coordinates = [0, 1, 2, 3]
x_coordinates = [0, 1, 2, 3, 4, 5, 6, 7]

x0_color_tuple  = (127,0,255)
x1_color_tuple  = (0,0,255)
x2_color_tuple  = (0,204,204)
x3_color_tuple  = (255, 255, 255)
x4_color_tuple  = (127,0,255)
x5_color_tuple  = (0,0,255)
x6_color_tuple  = (0,204,204)
